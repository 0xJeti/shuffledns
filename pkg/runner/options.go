...
type Options struct {
	...
	RCodeOutput     string // RCodeOutput is the file to write found erratic response codes to.
...
func ParseOptions() *Options {
	...
	flag.StringVar(&options.RCodeOutput, "oE", "", "File to write erratic responses to (optional)")
